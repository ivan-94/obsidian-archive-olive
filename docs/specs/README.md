...
| [BRAT Beta Release](brat-beta-release.md) | Pre-release authorized; post-release pilot remains | Defines the repository preparation, beta channel, validation, rollout, and rollback contract. |
