...
| [BRAT Beta Release](brat-beta-release.md)                           | `0.1.6` published; scoped review pending   | Defines the repository preparation, beta channel, validation, rollout, and rollback contract.   |
