...
| [BRAT Beta Release](brat-beta-release.md) | In implementation; private pilot remains | Defines the repository preparation, beta channel, validation, rollout, and rollback contract. |
