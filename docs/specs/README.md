...
| [BRAT Beta Release](brat-beta-release.md) | `0.1.1` contrast patch prepared; publication and retest pending | Defines the repository preparation, beta channel, validation, rollout, and rollback contract. |
