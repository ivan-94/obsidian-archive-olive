...
| [BRAT Beta Release](brat-beta-release.md) | `0.1.2` prepared; owner BRAT retest pending | Defines the repository preparation, beta channel, validation, rollout, and rollback contract. |
