...
Version `0.1.0` is a beta candidate validated on Obsidian Desktop `1.12.7` for macOS. It is not yet an official Obsidian community theme.
...
- Public packaging still needs a pilot-tested release tag and final community-theme checks.
